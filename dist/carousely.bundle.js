...
/***/ function(module, exports, __webpack_require__) {
	...
	var Carousel = function () {
	  function Carousel(slideContent) {
	    ...
	    this.slideShowIteration = 0;
	  }

	  _createClass(Carousel, [{
	    key: 'buildCarousel',
	    value: regeneratorRuntime.mark(function buildCarousel() {
	      return regeneratorRuntime.wrap(function buildCarousel$(_context) {
	        while (1) {
	    ...
	    value: function playCarousel() {
	      var carouselGenerator = this.buildCarousel();
	      ...
	      dot.forEach(function (dot) {
	        dot.addEventListener('mouseover' || 'click', function (e) {
	          ...
	          _this3.currentlyPlayingVideo().then(function (data) {
	            var currentlyPlaying = data.currentlyPlaying;
	            var jQueryVideoObj = data.jQueryObj;
	            var videoNumber = jQueryVideoObj.attr('data-video');
	            var currentDot = data.currentDot;
	            var nextDot = data.nextDot;
	            if (dotNumber === videoNumber) {
	              currentlyPlaying.play();
	            } else {
	              currentlyPlaying.pause();
	              currentlyPlaying.parentNode.style.display = 'none';
	            }
	          });
	    ...
	    value: function playFirstSlide(currentSlide, firstSlide, firstVideo, currentDot, firstDot) {
	      if (this.slideShowIteration < this.timesToItateThroughShow) {
	        currentSlide.style.display = "none";
	...
	var slideContent = __webpack_require__(299);
	var carousel = new Carousel(slideContent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var carousely = __webpack_require__(298);
